...
import { CuttingGroup } from '~/models/cutting-group.model'
import * as service from '~/services/cutting-group.service'
import { RequestBodyType } from '~/type'

const NAMESPACE = 'controllers/cutting-group'

export const createNewItem = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const dataRequest: CuttingGroup = {
      ...req.body,
